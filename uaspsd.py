...
""")
	...
	2. Open (Harga Pembukaan): Harga pembukaan adalah harga perdagangan PT Semen Indonesia (Persero) pada awal periode waktu tertentu, seperti hari perdagangan atau sesi perdagangan. Harga pembukaan menunjukkan harga perdagangan pertama dari PT Semen Indonesia (Persero) pada periode tersebut.
	3. High (Harga Tertinggi): Harga tertinggi adalah harga tertinggi yang dicapai oleh PT Semen Indonesia (Persero)selama periode waktu tertentu, seperti hari perdagangan atau sesi perdagangan. Harga tertinggi mencerminkan harga perdagangan tertinggi yang dicapai oleh PT Semen Indonesia (Persero) dalam periode tersebut.
	4. Low (Harga Terendah): Harga terendah adalah harga terendah yang dicapai oleh PT Semen Indonesia (Persero) selama periode waktu tertentu, seperti hari perdagangan atau sesi perdagangan. Harga terendah mencerminkan harga perdagangan terendah yang dicapai olehPT Semen Indonesia (Persero) dalam periode tersebut.
	6. Adj Close (Harga Penutupan yang Disesuaikan): Adj Close, atau harga penutupan yang disesuaikan, adalah harga penutupan yang telah disesuaikan untuk faktor-faktor seperti dividen, pemecahan saham, atau perubahan lainnya yang mempengaruhi harga saham PT Semen Indonesia (Persero). Ini memberikan gambaran yang lebih akurat tentang kinerja saham dari waktu ke waktu karena menghilangkan efek dari perubahan-perubahan tersebut.
	7. Volume: Volume dalam konteks data keuangan PT Semen Indonesia (Persero) mengacu pada jumlah saham yang diperdagangkan selama periode waktu tertentu, seperti hari perdagangan atau sesi perdagangan. Volume mencerminkan seberapa aktifnya perdagangan saham PT Semen Indonesia (Persero) dalam periode tersebut.
